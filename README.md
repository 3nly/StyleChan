...
StyleChan is a userscript functioning on top of 4chan X allowing you to customize the site with various themes and features.
...
Installing [4chan X](https://github.com/ccd0/4chan-x) is **RECOMMENDED** for StyleChan to work.\
...
- If you have any problems, try first resetting your StyleChan settings and then restarting your browser
